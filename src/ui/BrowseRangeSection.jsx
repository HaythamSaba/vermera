function BrowseRangeSection() {
  ...
  return (
    <section className="template flex flex-col items-center px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center">
          {rooms.map((room) => (
            <div key={room.title} className="w-full max-w-[381px] h-[480px]">
              <div className="w-full h-[420px] sm:h-[450px] lg:h-[480px] overflow-hidden rounded-lg mb-4 group">
                <img
                  src={room.image}
              ...
              <p className="font-semibold text-center text-2xl text-[#3A3A3A] mt-2">
                {room.title}
              </p>
            </div>
          ))}
