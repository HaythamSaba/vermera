...
const CoverBackgroundSection = ({ title, path }) => {
  return (
    <div className="relative">
      <div className="h-[316px] w-full relative bg-[url('/images/products-background.jpg')] bg-cover bg-center bg-no-repeat before:content-[''] before:absolute before:inset-0 before:bg-cream/50 before:backdrop-blur-xs">
